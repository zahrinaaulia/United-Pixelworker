    ...
    <div class="container">
      ...
      <hr id="hrpr">
          ...
          <div class="container0">
              <div> <h2 id="nav4" href="#">CATEGORY</h2></div>
              </div>
              <div class="container4">
                <div class="container5">
                <input type="radio" value="Apparel"> Apparel<br>
                </div>
                <div class="container5">
                <input type="radio" value="Kids"> Kids<br>
                </div>
                <div class="container5">
                <input type="radio" value="Accessories"> Accessories<br>
                </div>
                <div class="container5">
                <input type="radio" value="Hats"> Hats
                </div>
              </div>
            <div class="container0">
                <div> <h2 id="nav4" href="#">AVAILABILITY</h2></div>
                </div>
            <div class="container6">
              <input type="radio" value="On-Demand"> On-Demand <br>
